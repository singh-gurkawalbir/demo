...
export default {
  ...
  connections: `Connections store credentials and other information needed to access an application via its API. Connections can be shared with other integrator.io users to edit and create data flows that run in your integrator.io account. You can also check our Connector solutions articles for information on how to connect each supported app connector.`,
