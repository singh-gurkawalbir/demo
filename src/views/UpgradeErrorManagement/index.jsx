...
export default function UpgradeErrorManagement() {
  ...
  useEffect(() => {
    ...
    if (!canUserUpgradeToErrMgtTwoDotZero) {
      ...
      enqueueSnackbar({
        message: 'The new error management is being rolled out on an opt-in basis (excluding accounts with Integration Apps or Integration Apps license at present).',
        variant: 'error',
      });
      redirectToDashboard();
    }
