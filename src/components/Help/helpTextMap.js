...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'mapping.netsuite.lookup.searchField': 'Field name that is provided to the lookups defined, using this field name the respective field from the record will be extracted out and provided for the respective field in the import system.'
  // #region UI help text
};
