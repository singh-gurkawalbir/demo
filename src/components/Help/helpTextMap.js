...
export default {
  ...
  'docebo.connection.http.unencrypted.subdomain': 'Enter the subdomain of your Docebo account. For example, if <b>https://yoursubdomain.docebosaas.com/learn/signin</b> is the login URL, then <b>\'yoursubdomain\'</b> is the subdomain.',
