...
'If the files you are exporting are in a compressed format then please set this field to true.',
  ...
  'export.netsuite.distributed.useSS2Framework': 'Choose a NetSuite SuiteScript API version for configuring your step. When selecting SuiteApp SuiteScript 2.x or 1.0, the Celigo integrator.io SuiteApp must already be installed in your NetSuite account. Or for SuiteBundle SuiteScript 1.0, the Celigo integrator.io bundle must already be installed in your NetSuite account. Read more about the new SuiteScript 2.x APIs.<a href="https://docs.celigo.com/hc/en-us/articles/360047138512" target="_blank">here</a>',
  'export.netsuite.restlet.useSS2Restlets': 'Choose a NetSuite SuiteScript API version for configuring your step. When selecting SuiteApp SuiteScript 2.x or 1.0, the Celigo integrator.io SuiteApp must already be installed in your NetSuite account. Or for SuiteBundle SuiteScript 1.0, the Celigo integrator.io bundle must already be installed in your NetSuite account. Read more about the new SuiteScript 2.x APIs.<a href="https://docs.celigo.com/hc/en-us/articles/360047138512" target="_blank">here</a>',
  ...
  'import.netsuite_da.useSS2Restlets': 'Choose a NetSuite SuiteScript API version for configuring your step. When selecting SuiteApp SuiteScript 2.x or 1.0, the Celigo integrator.io SuiteApp must already be installed in your NetSuite account. Or for SuiteBundle SuiteScript 1.0, the Celigo integrator.io bundle must already be installed in your NetSuite account. Read more about the new SuiteScript 2.x APIs.<a href="https://docs.celigo.com/hc/en-us/articles/360047138512" target="_blank">here</a>',
