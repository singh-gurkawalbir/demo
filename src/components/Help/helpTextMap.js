...
if you're using a production account, you'll find your API keys under the 'API Management' page.<br>Multiple layers of protection, including AES 256 encryption, are in place to keep your API key safe. When editing this connection, you must re-enter this value each time; it is stored only when the connection is saved and never displayed as text.`,
  ...
  "connection.rdbms.bigquery.privateKey":
    "The private key for the Google Cloud service account used for authentication.",
...
use the custom option.`,
  ...
  "pull.integration":
    "The integration that you are pulling the changes from. This lists all direct clones of the current integration and existing parent clones.",
  "pull.reviewChanges":
    "Review the changes between the cloned and source integration. This list will show you all your changes in every export, import, flow, and script, but not API tokens or connections. You have to resolve all these conflicts before you can successfully merge the changes.",
  "pull.mergeChanges":
    "You can make changes to a source and cloned integration, then merge them. You must reconfigure your connections to merge your changes and there may be additional installation steps depending on available packages.",
  "revert.create":
