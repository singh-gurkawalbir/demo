...
'Define an \'input filter\' here to specify which source records should get processed. i.e. Records that evaluate to true are processed. Records that evaluate to false are ignored (but still passed along to downstream applications in the flow).',
  ...
  'sso.primaryAccount': 'The list includes all the accounts you have access to where SSO is enabled for the account. Choose the one you will use to sign in to integrator.io. When you sign in next time after selecting the account here, integrator.io will validate your SSO settings during sign-in against the SSO settings of the primary account.',
