...
export default {
  ...
  'saphana.connection.http.unencrypted.communicationArrangementUrlHost': 'Enter the Communication Arrangement URL Host for your SAP S/4HANA Cloud instance. If your instance is located at <b>https://my1234.s4hana.ondemand.com</b>, then enter <b>my1234</b>.<br> This URL can also be found under the "Communication Arrangement" tab → "API-URL" field in your SAP S/4HANA Cloud instance.',
  'saphana.connection.http.auth.basic.username': 'Enter the user name from the Communication Arrangement.<br> For more information, refer to <a href=https://blogs.sap.com/2017/11/09/setting-up-communication-management-in-sap-s4hana-cloud/>Setting up Communication Management in SAP S/4HANA Cloud</a>',
