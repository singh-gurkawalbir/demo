...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'import.description':
    'Describe your resource so that other users can quickly understand what it is doing without having to read through all the fields and settings. Be sure to highlight any nuances that a user should be aware of before using your resource in their flows. Also, as you make changes to the import be sure to keep this field up to date.',
  'import.blobKeyPath':
  ...
  'import.netsuite_da.recordType': `Specify the NetSuite record type you want to import. You can choose any standard record type (i.e. customer, sales order, journal entry) or any custom record type that has been defined in your NetSuite account. This list depends on the permissions associated with the NetSuite connection being used. If you add any new custom record types to your NetSuite account, or if there are any changes to the permissions associated with the connection being used, you can click refresh icon to update the list.`,
