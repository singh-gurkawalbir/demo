...
'Invite users from any integrator.io account to share your stack, which will allow them to invoke the functions in your stack from their integration flows. You may revoke their access from this screen at any time.',
  ...
  'pageGenerator.checkExistingExport': 'Select an existing export, listener, or transfer that you have already created in your account for this application, in order to add that same resource to the current flow. To set up a new resource, leave this field blank and click <b>Next</b>.',
  ...
  'pageProcessor.checkExistingImport': 'Select an existing import, lookup, or transfer that you have already created in your account for this application, in order to add that same resource to the current flow. To set up a new resource, leave this field blank and click <b>Next</b>.',
  'pageProcessor.checkExistingExport': 'Select an existing import, lookup, or transfer that you have already created in your account for this application, in order to add that same resource to the current flow. To set up a new resource, leave this field blank and click <b>Next</b>.',
...
'Define an \'input filter\' here to specify which source records should get processed. i.e. Records that evaluate to true are processed. Records that evaluate to false are ignored (but still passed along to downstream applications in the flow).',
  ...
  'export.assistantMetadata.resource': 'Select a resource. Resources are typically ‘Customers’ and ‘Orders’. Refer to the API documentation for the application you’re connecting.',
  'export.assistantMetadata.operation': 'Select an API endpoint to perform an operation on the selected resource. Typically, these endpoints create, update, retrieve, or delete records. Refer to the API documentation for the application you’re connecting.',
  'export.assistantMetadata.version': 'This application has multiple versions. Select the appropriate API version. Refer to the API documentation of the application you’re trying to connect.',
  'import.assistantMetadata.resource': 'Select a resource. Resources are typically ‘Customers’ and ‘Orders’. Refer to the API documentation for the application you’re connecting.',
  'import.assistantMetadata.operation': 'Select an API endpoint to perform an operation on the selected resource. Typically, these endpoints create, update, retrieve, or delete records. Refer to the API documentation for the application you’re connecting.',
  'import.assistantMetadata.version': 'This application has multiple versions. Select the appropriate API version. Refer to the API documentation of the application you’re trying to connect.',
};
