...
'Define an \'input filter\' here to specify which source records should get processed. i.e. Records that evaluate to true are processed. Records that evaluate to false are ignored (but still passed along to downstream applications in the flow).',
  ...
  'export.http._httpConnectorVersionId': 'This application has multiple versions. Select the appropriate API version. Refer to the API documentation of the application you’re trying to connect.',
  ...
  'import.http._httpConnectorVersionId': 'This application has multiple versions. Select the appropriate API version. Refer to the API documentation of the application you’re trying to connect.',
};
