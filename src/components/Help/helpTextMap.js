...
'Define an \'input filter\' here to specify which source records should get processed. i.e. Records that evaluate to true are processed. Records that evaluate to false are ignored (but still passed along to downstream applications in the flow).',
  ...
  'connectorLicense.email': 'This field is non-editable. It displays the customer’s email.',
  'connectorLicense.trialEndDate': 'Select the date that the trial subscription expires. The Integration App (IA) owner can edit the field based on changes in the trial subscription.',
  'connectorLicense.expires': 'Select the date that the subscription license expires. The Integration App (IA) owner can edit the field based on any changes in the subscription license.',
  'connectorLicense.sandbox': 'This field is non-editable. It displays the customer environment as production or sandbox based on the subscription license.',
