...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'export.file.backupPath': 'Specify the directory path of the storage provider folder where files will be backed up after successful transfer.',
  ...
  'import.file.fileName':
    "Use this field to specify how the files being uploaded to the storage provider site should be named.  You can type '{{{' to include a predefined timestamp template in your file name.  For example, 'FileXYZ-{{{timestamp \"YY-MM-DD\" \"America/Los_Angeles\"}}}.txt' will upload files with the following pattern: 'FileXYZ-16-06-30.txt' in America/Los_Angeles time.  Please note also that you can include whatever file name extension you like, and the file name extension will never change the type of data being generated.",
  ...
  'import.file.backupPath': 'Specify the directory path of the storage provider folder where files will be backed up after successful transfer.',
  'import.s3.region':
