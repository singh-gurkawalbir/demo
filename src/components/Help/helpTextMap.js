...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'export.rdbms.query': 'Enter a SQL query that retrieves the records you want to export from your source database.</br>Note : For Delta exports please use lastExportDateTime or currentExportDateTime in the query.</br>Oracle SQL example : SELECT * FROM TABLE_NAME where COLUMN_NAME > TO_TIMESTAMP({{lastExportDateTime}}, \'YYYY-MM-DD"T"HH24:MI:SS.ff3"Z"\').</br>MYSQL example : SELECT * FROM TABLE_NAME where COLUMN_NAME > {{lastExportDateTime}}.',
