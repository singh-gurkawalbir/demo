...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'freshworks.connection.domain': 'Please select your Freshworks CRM domain. This can be found in your log in URL. All the new accounts will have <b>myfreshworks</b> as domain',
