...
'Define an \'input filter\' here to specify which source records should get processed. i.e. Records that evaluate to true are processed. Records that evaluate to false are ignored (but still passed along to downstream applications in the flow).',
  ...
  'assistantMetadata.resource': 'Select a resource. Resources are typically ‘Customers’ and ‘Orders’. Refer to the API documentation for the application you’re connecting.',
  'assistantMetadata.operation': 'Select an API endpoint to perform an operation on the selected resource. Typically, these endpoints create, update, retrieve, or delete records. Refer to the API documentation for the application you’re connecting.',
  'assistantMetadata.version': 'This application has multiple versions. Select the appropriate API version. Refer to the API documentation of the application you’re trying to connect.',
};
