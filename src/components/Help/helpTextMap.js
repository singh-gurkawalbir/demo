...
'Invite users from any integrator.io account to share your stack, which will allow them to invoke the functions in your stack from their integration flows. You may revoke their access from this screen at any time.',
  ...
  'pageGenerator.checkExistingExport': 'Select an existing resource (import, lookup, or transfer) to add to this flow.<br/> <b>Note: Any edits you make to an existing resource will also apply to all other flows that use it, so verify that no other flows will break as a consequence.</b><br/><br/>To set up a new resource, leave this box unchecked and click <b>Next.</b>',
  ...
  'pageProcessor.checkExistingExport': 'Select an existing resource (import, lookup, or transfer) to add to this flow.<br/> <b>Note: Any edits you make to an existing resource will also apply to all other flows that use it, so verify that no other flows will break as a consequence.</b><br/><br/>To set up a new resource, leave this box unchecked and click <b>Next.</b>',
