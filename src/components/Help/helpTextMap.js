...
export default {
 ...
 Please note that there are multiple layers of protection in place (including AES 256 encryption) to keep your API key safe.`,
  ...
  'import.ftp.backupDirectoryPath': 'Specify the directory path of the FTP folder where files will be moved after successful transfer.',
  'import.s3.region':
  ...
  'import.s3.backupBucket': 'Specify the bucket name where files will be moved after successful transfer.',
