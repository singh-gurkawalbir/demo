import settings from '../../reducers/session/integrationApps/settings';
...
export default {
  ...
  'connection.http.unencrypted.Store_Code': 'Enter the store code, as listed in your Miva store&amp;s settings',
