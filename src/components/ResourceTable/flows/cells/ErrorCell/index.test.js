...
describe('Error Cell of floe tb=sble ui test cases', () => {
  ...
  test('should show error count as 5', () => {
    ...
    expect(link).toHaveAttribute('href', '/parentURL/flow_id1/errorsList');
  });
  test('should show only one error', () => {
    ...
    expect(link).toHaveAttribute('href', '/parentURL/flow_id2/errorsList');
  });
});
