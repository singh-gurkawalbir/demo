...
describe("home Tile's Status cell ui tests", () => {
  ...
  test('should show Success when no connection is offline', () => {
  ...
  test('should show ConnectionDown because of offline connection', () => {
  ...
  test('should click status pending setup', () => {
