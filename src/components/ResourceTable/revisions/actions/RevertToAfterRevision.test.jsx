...
describe('UI test cases for revert to after revision ', () => {
  beforeEach(() => {
    jest.resetAllMocks();
  });
  test('should call onclick', () => {
    ...
    expect(mockHistoryPush).toHaveBeenCalledWith('/parent/revert/randomvalue/open/toAfter/revision/somereqAndResKey');
  });
});
