...
describe('editableText testing', () => {
  test('should enter some value in input', async () => {
  ...
  test('should test with some default text', async () => {
    const onchange = jest.fn();
  ...
  test('should test when the disable is set to true', async () => {
    const onchange = jest.fn();
  ...
  test('should test key down escape', async () => {
    const onchange = jest.fn();
  ...
  test('should test key down enter', async () => {
    const onchange = jest.fn();
