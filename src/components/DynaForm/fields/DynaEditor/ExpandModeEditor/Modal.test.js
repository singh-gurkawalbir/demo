...
describe('editorModal UI tests', () => {
  ...
  test('should display the error message when validateContent is true and mode is json for the editor content', () => {
  ...
  test('should not display the error message when validateContent is true and mode is not json for the editor content', () => {
  ...
  test('should not display the error message when validateContent is false for the editor content', () => {
