...
function initDynaCsvGenerate(props = {}) {
  initialStore.getState().data.resources.exports = [{_id: '63515cc28eab567612a83249', name: 'import1', adaptorType: 'HTTPImport'}];
...
describe('DynaCsvGenerate_afe UI tests', () => {
  ...
  test('should make a dipatch call and URL redirection when "Create child license" is clicked', async () => {
    ...
    await waitFor(() => expect(mockHistoryPush).toBeCalledWith('/exports/edit/imports/63515cc28eab567612a83249/editor/filecsv/editor/filecsv'));
  });
});
