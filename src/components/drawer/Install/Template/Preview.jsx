...
const useStyles = makeStyles(theme => ({
  ...
  appLogosContainer: {
    ...
    height: 160,
    top: theme.spacing(-2),
    backgroundImage: 'url(https://www.celigo.com/wp-content/themes/Avada-Child-Theme/images/blue-bg.svg), linear-gradient(0deg, #0E7DC1 6.37%, #53C9F0 78.65%, #56CCF2 145.37%)',
