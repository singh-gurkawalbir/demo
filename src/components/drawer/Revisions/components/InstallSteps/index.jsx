...
import { PULL_MERGE_SUCCESS, REVERT_SUCCESS } from '../../../../../utils/revisions';
...
export default function InstallSteps({ integrationId, revisionId, onClose }) {
  ...
  useEffect(() => {
    if (areAllRevisionInstallStepsCompleted) {
      enqueueSnackbar({ message: revisionType === REVISION_TYPES.PULL ? PULL_MERGE_SUCCESS : REVERT_SUCCESS });
      onClose();
    }
