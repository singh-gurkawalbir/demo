export default {
  ...
  compactRow: {
    gridTemplateColumns: '1fr auto 1fr',
    gridTemplateRows: '1fr auto 1fr auto 0fr',
    gridTemplateAreas: `"rule rule rule"
  ...
  column: {
    ...
    gridTemplateAreas: `"rule dragBar_v_0 data dragBar_v_1 result"
  ...
  jsonFormBuilder: {
    ...
    gridTemplateRows: '1fr auto 1fr auto 0fr',
    gridTemplateAreas: `"meta dragBar_v_0 form"
                        "meta dragBar_v_0 dragBar_h_0" 
                        "meta dragBar_v_0 values" 
                        "dragBar_h_1 dragBar_h_1 dragBar_h_1" 
                        "error error error"`,
  },
  scriptFormBuilder: {
