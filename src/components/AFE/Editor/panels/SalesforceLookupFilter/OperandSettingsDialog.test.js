...
describe('OperandSettingsDialog UI test cases', () => {
  test('should call onSubmit function with type field when field radio button is selected and saved', () => {
  ...
  test('should call onSubmit function with type vale when value radio button is selected and saved', () => {
