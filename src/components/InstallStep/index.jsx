        ...
        <div className={classes.logoWithAction}>
          <div className={classes.imgBlock}>
            ...
            <ApplicationImg
              size="small"
              type={
                step?.options?.connectionType?.toLowerCase() || step?.sourceConnection?.http?.formType === 'assistant' ? 'workday' : step?.sourceConnection?.http?.formType || step?.sourceConnection?.type || ''
              }
