...
export function integrationUninstallSteps(state, { integrationId, isFrameWork2 }) {
  ...
  const { steps: uninstallSteps, error, isFetched, redirectTo } = uninstallData;
  ...
  if (visibleSteps.length === 0) {
    return { steps: emptyStepsArr, error, isFetched, redirectTo };
  }
  ...
  return { steps: modifiedSteps, error, isFetched, redirectTo };
}
