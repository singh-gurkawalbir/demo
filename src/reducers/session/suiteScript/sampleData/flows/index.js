...
export default function(state = {}, action) {
  ...
  return produce(state, draft => {
    switch (type) {
      case actionTypes.SUITESCRIPT.FLOW_DATA.INIT: {
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.STAGE_REQUEST: {
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.PREVIEW_DATA_REQUEST: {
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.PREVIEW_DATA_RECEIVED: {
        if (!resourceId) return;
        const resourceMap =
          (draft[flowId] &&
            draft[flowId][
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.PROCESSOR_DATA_REQUEST: {
        const resourceMap =
          (draft[flowId] &&
            draft[flowId][
              isPageGeneratorResource(draft[flowId], resourceId)
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.PROCESSOR_DATA_RECEIVED: {
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.RECEIVED_ERROR: {
        const resourceMap =
          (draft[flowId] &&
            draft[flowId][
              isPageGeneratorResource(draft[flowId], resourceId)
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.FLOW_RESPONSE_MAPPING_UPDATE: {
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.RESET: {
        const flow = draft[flowId];
      ...
      case actionTypes.SUITESCRIPT.FLOW_DATA.FLOW_SEQUENCE_RESET: {
