...
describe('integrationApps selector testcases', () => {
  ...
  describe('selectors.integrationAppLicense test cases', () => {
    ...
    test('should return license details for the integration app for owner user for non-expired', () => {
      const state = reducer(
        {
          user: {
            org: {
                    ...
                    licenses: [
                      {
                        _id: 'l1',
                        _integrationId: 'i1',
                        expires: '2030-08-18T06:00:43.721Z',
                        created: '2018-07-10T10:03:02.169Z',
                      },
                    ],
                  },
      ...
      expect(selectors.integrationAppLicense(state, 'i1')).toEqual({
        ...
        createdText: 'Started on Jul 10th, 2018',
        expires: '2030-08-18T06:00:43.721Z',
        expiresText: 'Expires on Aug 18th, 2030',
    ...
    test('should return license details for the integration app for non owner user for non-expired', () => {
      const state = reducer(
        {
          user: {
            org: {
