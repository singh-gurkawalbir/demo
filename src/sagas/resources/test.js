...
describe('getResourceCollection saga', () => {
  ...
  test('should dispatch received collection action if api call succeeds and resourceType is tree/metadata with empty response', () => {
    ...
    const refresh = 'true';
    const path = '/integrations/integrationId/tree/metadata?additionalFields=_connectorId,_parentId,sandbox,settings,settingsForm,preSave,changeEditionSteps,flowGroupings,_registeredConnectionIds,uninstallSteps,installSteps,createdAt';
