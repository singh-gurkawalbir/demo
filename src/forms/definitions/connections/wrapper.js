...
export default {
  init: (fieldMeta, resource = {}) => {
    ...
    const unEncryptedText = resource && resource.wrapper && resource.wrapper.unencrypted && Object.prototype.toString.apply(resource.wrapper.unencrypted) === '[object Object]' ? JSON.stringify(resource.wrapper.unencrypted) : resource?.wrapper?.unencrypted;
