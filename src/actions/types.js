...
const INTEGRATION_APPS = {
  ...
  SETTINGS: {
    ...
    REQUEST_S3_KEY: 'INTEGRATION_APPS_SETTINGS_GET_S3_KEY',
    RECEIVED_S3_KEY: 'INTEGRATION_APPS_SETTINGS_S3_KEY_RECEIVED',
    S3_KEY_FAILED: 'INTEGRATION_APPS_SETTINGS_S3_KEY_FAILED',
