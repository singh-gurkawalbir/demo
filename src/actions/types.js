...
const METADATA = {
  ...
  RECEIVED_ASSISTANT: 'RECEIVED_ASSISTANT',
};
const FILE_DEFINITIONS = {
  SUPPORTED: {
    REQUEST: 'REQUEST_SUPPORTED_FILE_DEFINITIONS',
    RECEIVED: 'RECEIVED_SUPPORTED_FILE_DEFINITIONS',
    RECEIVED_ERROR: 'RECEIVED_SUPPORTED_FILE_DEFINITIONS_ERROR',
  },
  USER_SUPPORTED: {
    REQUEST: 'REQUEST_USER_SUPPORTED_FILE_DEFINITIONS',
    RECEIVED: 'RECEIVED_USER_SUPPORTED_FILE_DEFINITIONS',
    RECEIVED_ERROR: 'RECEIVED_USER_SUPPORTED_FILE_DEFINITIONS',
  },
  DEFINITION: {
    SUPPORTED: {
      UPDATE: 'UPDATE_SUPPORTED_DEFINITION',
      RECEIVED: 'RECEIVED_SUPPORTED_DEFINITION',
      RECEIVED_ERROR: 'RECEIVED_SUPPORTED_DEFINITION_ERROR',
    },
    USER_SUPPORTED: {
      REQUEST: 'REQUEST_USER_SUPPORTED_DEFINITION',
      UPDATE: 'UPDATE_USER_SUPPORTED_DEFINITION',
      RECEIVED: 'RECEIVED_USER_SUPPORTED_DEFINITION',
      RECEIVED_ERROR: 'RECEIVED_USER_SUPPORTED_DEFINITION_ERROR',
    },
  },
};
const CONNECTORS = {
...
const RESOURCE_FORM = {
  ...
  SUBMIT_WITH_RAW_DATA: 'RESOURCE_FORM_SUBMIT_WITH_RAW_DATA',
