...
const FORM = {
  ...
  CLEAR: 'CLEAR_FORM',
  FIELD: {
    REGISTER: 'REGISTER_FIELD_IN_FORM',
    ON_FIELD_CHANGE: 'ON_FIELD_CHANGE_IN_FORM',
    ON_FIELD_FOCUS: 'ON_FIELD_FOCUS_IN_FORM',
    ON_FIELD_BLUR: 'ON_FIELD_BLUR_IN_FORM',
  },
};
const METADATA = {
...
const INTEGRATION_APPS = {
  ...
  SETTINGS: {
    ...
    RECEIVED_ON_OFF_ACTION_STATUS:
      'INTEGRATION_APPS_SETTINGS_RECEIVED_RECEIVED_ON_OFF_ACTION_STATUS',
