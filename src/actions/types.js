...
const INTEGRATION_APPS = {
  INSTALLER: {
    STEP_INSTALL: 'INTEGRATION_APPS_STEP_INSTALL',
    STEP_INSTALL_IN_PROGRESS: 'INTEGRATION_APPS_STEP_INSTALL_IN_PROGRESS',
    STEP_INSTALL_VERIFY: 'INTEGRATION_APPS_STEP_INSTALL_VERIFY',
    STEP_INSTALL_FAILURE: 'INTEGRATION_APPS_STEP_INSTALL_FAILURE',
    STEP_INSTALL_COMPLETE: 'INTEGRATION_APPS_STEP_INSTALL_COMPLETE',
  },
  UNINSTALLER: {
    PRE_UNINSTALL: 'INTEGRATION_APPS_UNINSTALLER_PRE_UNINSTALL',
    UNINSTALL_STEPS_RECEIVED:
