...
const FLOW_DATA = {
  INIT: 'FLOW_DATA_INIT',
  REQUEST_PREVIEW: 'REQUEST_FLOW_DATA_PREVIEW',
  RECEIVED_PREVIEW: 'RECEIVED_FLOW_DATA_PREVIEW',
  REQUEST_PROCESSOR: 'REQUEST_FLOW_DATA_PROCESSOR',
  RECEIVED_PROCESSOR: 'RECEIVED_FLOW_DATA_PROCESSOR',
  FETCH_SAMPLE_DATA: 'FETCH_FLOW_SAMPLE_DATA',
  RESET: 'RESET_FLOW_DATA',
  UPDATE_FLOWS: 'UPDATE_FLOWS_DATA',
};
