...
const REQUEST_METADATA_COLLECTION = 'REQUEST_METADATA_COLLECTION';
const RECEIVED_NETSUITE_COLLECTION = 'RECEIVED_NETSUITE_COLLECTION';
...
const RESOURCE_FORM = {
  ...
  INIT_CUSTOM_FORM: 'RESOURCE_FORM_INIT_CUSTOM_FORM',
...
export default {
  REQUEST_METADATA_COLLECTION,
  RECEIVED_NETSUITE_COLLECTION,
  CANCEL_TASK,
  TEST_CONNECTION,
  RELOAD_APP,
  UPDATE_PROFILE,
