...
const INTEGRATION_APPS = {
  ...
  SETTINGS: {
    ...
    SAVE_CATEGORY_MAPPINGS: 'INTEGRATION_APPS_SETTINGS_SAVE_CATEGORY_MAPPINGS',
    SAVE_CATEGORY_MAPPINGS_FAILED:
      'INTEGRATION_APPS_SETTINGS_SAVE_CATEGORY_MAPPINGS_FAILED',
