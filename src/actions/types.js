...
const LOGS = {
  SCRIPT: {
    LOGS_REQUEST: 'SCRIPT_LOGS_REQUEST',
    LOGS_REQUEST_FAILED: 'SCRIPT_LOGS_REQUEST_FAILED',
    LOGS_RECEIVED: 'SCRIPT_LOGS_RECEIVED',
    SET_DEPENDENCY: 'SCRIPT_LOGS_SET_DEPENDENCY',
    PATCH_FILTER: 'SCRIPT_LOGS_PATCH_FILTER',
    LOGS_CLEAR: 'SCRIPT_LOGS_CLEAR',
    START_DEBUG: 'SCRIPT_START_DEBUG',
    DEBUG_LOGS_REQUEST: 'SCRIPT_DEBUG_LOGS_REQUEST',
    LOGS_REFRESH: 'SCRIPT_LOGS_REFRESH',
    LOGS_LOAD_MORE: 'SCRIPT_LOGS_LOAD_MORE',
  },
  CONNECTION: {
    REQUEST: 'CONNECTION_LOGS_REQUEST',
    REQUEST_FAILED: 'CONNECTION_LOGS_REQUEST_FAILED',
    RECEIVED: 'CONNECTION_LOGS_RECEIVED',
    REFRESH: 'CONNECTION_LOGS_REFRESH',
    CLEAR: 'CONNECTION_LOGS_CLEAR',
    DELETE: 'CONNECTION_LOGS_DELETE',
    DOWNLOAD: 'CONNECTION_LOGS_DOWNLOAD',
