...
const MAPPINGV2 = {
  INIT: 'MAPPINGV2_INIT',
  INIT_COMPLETE: 'MAPPINGV2_INIT_COMPLETE',
  PATCH_FIELD: 'MAPPINGV2_PATCH_FIELD',
  PATCH_INCOMPLETE_GENERATES: 'MAPPINGV2_PATCH_INCOMPLETE_GENERATES',
  PATCH_SETTINGS: 'MAPPINGV2_PATCH_SETTINGS',
  SET_VISIBILITY: 'MAPPINGV2_SET_VISIBILITY',
  DELETE: 'MAPPINGV2_DELETE',
  UPDATE_LOOKUP: 'MAPPINGV2_UPDATE_LOOKUP',
  SAVE: 'MAPPINGV2_SAVE',
  SAVE_COMPLETE: 'MAPPINGV2_SAVE_COMPLETE',
  SAVE_FAILED: 'MAPPINGV2_SAVE_FAILED',
  PREVIEW_REQUESTED: 'MAPPINGV2_PREVIEW_REQUESTED',
  PREVIEW_RECEIVED: 'MAPPINGV2_PREVIEW_RECEIVED',
  PREVIEW_FAILED: 'MAPPINGV2_PREVIEW_FAILED',
  CHANGE_ORDER: 'MAPPINGV2_CHANGE_ORDER',
  SET_NS_ASSISTANT_FORM_LOADED: 'MAPPINGV2_SET_NS_ASSISTANT_FORM_LOADED',
  REFRESH_GENERATES: 'MAPPINGV2_REFRESH_GENERATES',
  UPDATE_LAST_TOUCHED_FIELD: 'MAPPINGV2_UPDATE_LAST_TOUCHED_FIELD',
  UPDATE_MAPPINGS: 'MAPPINGV2_UPDATE_MAPPINGS',
  CHECK_FOR_SF_SUBLIST_EXTRACT_PATCH: 'MAPPINGV2_CHECK_FOR_SF_SUBLIST_EXTRACT_PATCH',
  CLEAR: 'MAPPINGV2_CLEAR',
};
