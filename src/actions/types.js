...
export const FETCH_RESOURCE_REFERENCES = 'FETCH_RESOURCE_REFERENCES';
export const RECEIVED_RESOURCE_REFERENCES = 'RECEIVED_RESOURCE_REFERENCES';
const METADATA = {
...
const baseResourceActions = [
  ...
  DELETE,
  DELETED,
  FETCH_RESOURCE_REFERENCES,
  RECEIVED_RESOURCE_REFERENCES,
];
...
const AGENT_TOKEN_DISPLAY = 'AGENT_TOKEN_DISPLAY';
const AGENT_TOKEN_CHANGE = 'AGENT_TOKEN_CHANGE';
const AGENT_TOKEN_MASK = 'AGENT_TOKEN_MASK';
const AGENT_TOKEN_RECEIVED = 'AGENT_TOKEN_RECEIVED';
const AGENT_DOWNLOAD_INSTALLER = 'AGENT_DOWNLOAD_INSTALLER';
