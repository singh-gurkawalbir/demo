...
// This is a copy of the AppBlock. Ideally we could refactor
// this to be an identical react-flow node type for any step export or import.
// little work has been done so far to make this happen.
// the first step is to remove the use of the flowActions. They should be replaced
// with a simple tokenized list of what processors to render instead of a set of
// component. A single callback should be added as a prop that gets fired for every processor
// click and just passes the processor name in the event. Since the parent component defines the
// callback, then it should know exactly what to do given its own state and knowing what processor
// was clicked.

// This is a future effort, so I will not work on it until all major branching tasks are complete.
...
import ActionIconButton from '../../../../../../views/FlowBuilder/ActionIconButton';
import ResourceButton from '../../../../../../views/FlowBuilder/ResourceButton';
import ErrorStatus from '../../../../../../views/FlowBuilder/ErrorStatus'; // uses redux and url
import BubbleSvg from '../../../../../../views/FlowBuilder/BubbleSvg';
