...
Example.args = {
  results: {
    ...
    imports: [
      { lastModified: '2021-08-10T21:29:37Z', name: 'Import 1', description: 'Description of the 1st import.' },
    ],
    exports: [
      { lastModified: '2019-12-18T21:29:37Z', name: 'Export 1', description: 'Description of the 1st Export.' },
      { lastModified: '2019-12-18T21:29:37Z', name: 'Export 2', description: 'Description of the 2nd Export.' },
    ],
    connections: [
...
/*
  <GlobalSearch
    ...
    onKeywordChange={}
    blacklist={'flow', 'marketlace}
    defaultKeyword="starting keyword"
    defaultFilter={[]}
    />
*/
