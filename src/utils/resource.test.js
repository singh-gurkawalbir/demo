...
describe('resource util tests', () => {
  ...
  describe('tests for util isTradingPartnerSupported', () => {
    test('should return false if nothing as passed as parameters', () => {
  ...
  describe('tests for util isNetSuiteBatchExport', () => {
    test('should return false if nothing as passes as parameters', () => {
  ...
  describe('tests for util getUniqueFieldId', () => {
    test('should return empty string if nothing as passes as parameters', () => {
  ...
  describe('tests for util getUserAccessLevelOnConnection', () => {
    test('should return undefined if nothing as passes as parameters', () => {
