...
export const AMPERSAND_ROUTES = [
  '/pg/flows/create',
  '/pg/orchestrations/create',
  '/pg/flow-builder/v1_5/create',
  '/pg/integrations/create',
  '/pg/:resourceType/create',
  '/pg/:resourceType/:resourceId/edit',
  '/pg/data-loader',
  '/pg/integrations/:integrationId/data-loader',
  '/pg/integrations/:integrationId/data-loader/:flowId/edit',
  ...
  '/pg/connectors/:connectorId/licenses',
  '/pg/connectors/:connectorId/licenses/create',
  '/pg/connectors/:connectorId/licenses/:licenseId/edit',
  '/pg/clone/integrations/:_integrationId/:resourceType/:resourceId/preview',
  '/pg/clone/integrations/:_integrationId/:resourceType/:resourceId/setup',
