      ...
      const expectedResult = {
        ...
        installSteps: [
          ...
          },
          {
            ...
            name: 'Integrator Bundle for "NetSuite Connection"',
            options: {},
            type: 'installPackage',
          },
          {
      ...
      const expectedResult = {
        ...
        installSteps: [
          ...
          },
          {
            ...
            imageURL: 'images/company-logos/netsuite.png',
            installURL: '/app/bundler/bundledetails.nl?sourcecompanyid=TSTDRV916910&domain=PRODUCTION&config=F&id=20038',
            name: 'Integrator Bundle for "Netsuite Connection 1"',
            options: {},
            type: 'installPackage',
          },
          {
            ...
            imageURL: 'images/company-logos/netsuite.png',
            installURL: '/app/bundler/bundledetails.nl?sourcecompanyid=TSTDRV916910&domain=PRODUCTION&config=F&id=20038',
            name: 'Integrator Bundle for "Netsuite Connection 2"',
            options: {},
            type: 'installPackage',
          },
          {
      ...
      const expectedResult = {
        ...
        installSteps: [
          ...
          },
          {
            ...
            name: 'Integrator Suiteapp for Netsuite Connection 1',
            application: 'netsuite',
            type: 'installPackage',
            options: {},
          },
