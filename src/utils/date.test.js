...
describe('date util function test', () => {
  ...
  describe('convertUtcToTimezone function test', () => {
    ...
    test('should not throw exception for bad params', () => {
      ...
      expect(convertUtcToTimezone(testDate, '')).toEqual(' 5:03:30 am');
    ...
    test('should return correct time for convertUtctoTimezone in expected date and time formats', () => {
      expect(convertUtcToTimezone(testDate, 'MM/DD/YY', 'hh:mm')).toEqual('12/24/18 05:03');
      expect(convertUtcToTimezone(testDate, 'MM/DD/YYYY', 'hh:mm')).toEqual('12/24/2018 05:03');
      expect(convertUtcToTimezone(testDate, 'MM/DD/YY', 'HH:mm')).toEqual('12/24/18 05:03');
      expect(convertUtcToTimezone(testDate, 'MM/DD/YY', 'hh:mm:ss')).toEqual('12/24/18 05:03:30');
      expect(convertUtcToTimezone(testDate, 'MM/DD/YY', 'hh:mm:ss a')).toEqual('12/24/18 05:03:30 am');
      expect(convertUtcToTimezone(testDate, 'MM/DD/YY', 'hh:mm:ss A')).toEqual('12/24/18 05:03:30 AM');
    });

    test('should return in default time and date formats when formats not passed in params', () => {
      expect(convertUtcToTimezone(testDate)).toEqual('12/24/2018 5:03:30 am');
    });
