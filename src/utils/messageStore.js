const messages = {
  ...
  MULTIPLE_INSTALLS: 'Looks like this Integration App is already installed in your account. If you would like to install another instance please provide a unique tag name so that we can help you differentiate this install from the others.',
  ...
  LICENSE_UPGRADE_REQUEST_RECEIVED: 'Thanks for your request! We will be in touch soon.',
  ...
  ALIAS_DELETE_CONFIRM_MESSAGE: 'Are you sure you want to delete your alias? If you delete it, then any resources that reference the alias will now reference the ID. You’ll need to update the resource with a new or existing alias if you want to reference a different alias.',
  ...
  ALIAS_SAVE_MESSAGE: 'You’ve successsfully created an alias.',
  ALIAS_DELETE_MESSAGE: 'You’ve successsfully deleted your alias.',
