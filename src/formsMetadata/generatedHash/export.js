export default {
  ...
  connectionRest_iClientId: {
    type: 'text',
    helpKey: 'connection.rest._iClientId',
    name: '/rest/_iClientId',
    id: 'connectionRest_iClientId',
    label: 'Rest _iClientId',
    defaultValue: '{{rest._iClientId}}',
  },
  connectionRestInfo: {
    type: 'text',
  ...
  // #endregion rest
  // #region http
  connectionHttp_iClientId: {
    type: 'text',
    helpKey: 'connection.http._iClientId',
    name: '/http/_iClientId',
    id: 'connectionHttp_iClientId',
    label: 'Http _iClientId',
    defaultValue: '{{http._iClientId}}',
  },
  ...
  connectionHttpPing_id: {
    type: 'text',
    helpKey: 'connection.http.ping._id',
    name: '/http/ping/_id',
    id: 'connectionHttpPing_id',
    label: 'Http ping _id',
    defaultValue: '{{http.ping._id}}',
  },
  ...
  connectionHttpAuth_id: {
    type: 'text',
    helpKey: 'connection.http.auth._id',
    name: '/http/auth/_id',
    id: 'connectionHttpAuth_id',
    label: 'Http auth _id',
    defaultValue: '{{http.auth._id}}',
  },
  ...
  connectionHttpRateLimit_id: {
    type: 'text',
    helpKey: 'connection.http.rateLimit._id',
    name: '/http/rateLimit/_id',
    id: 'connectionHttpRateLimit_id',
    label: 'Http rateLimit _id',
    defaultValue: '{{http.rateLimit._id}}',
  },
  ...
  connectionAs2PartnerStationInfoAuth_id: {
    type: 'text',
    helpKey: 'connection.as2.partnerStationInfo.auth._id',
    name: '/as2/partnerStationInfo/auth/_id',
    id: 'connectionAs2PartnerStationInfoAuth_id',
    label: 'As2 partnerStationInfo auth _id',
    defaultValue: '{{as2.partnerStationInfo.auth._id}}',
  },
  ...
  connectionAs2PartnerStationInfoRateLimit_id: {
    type: 'text',
    helpKey: 'connection.as2.partnerStationInfo.rateLimit._id',
    name: '/as2/partnerStationInfo/rateLimit/_id',
    id: 'connectionAs2PartnerStationInfoRateLimit_id',
    label: 'As2 partnerStationInfo rateLimit _id',
    defaultValue: '{{as2.partnerStationInfo.rateLimit._id}}',
  },
  ...
  connectionNetsuite_iClientId: {
    type: 'text',
    helpKey: 'connection.netsuite._iClientId',
    name: '/netsuite/_iClientId',
    id: 'connectionNetsuite_iClientId',
    label: 'Netsuite _iClientId',
    defaultValue: '{{netsuite._iClientId}}',
  },
  // #endregion netsuite
  ...
  connectionSalesforce_iClientId: {
    type: 'text',
    helpKey: 'connection.salesforce._iClientId',
    name: '/salesforce/_iClientId',
    id: 'connectionSalesforce_iClientId',
    label: 'Salesforce _iClientId',
    defaultValue: '{{salesforce._iClientId}}',
  },
